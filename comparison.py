...
def likelihood_of_superiority(win_ratio, nb_plays):
    wins = win_ratio * nb_plays /100.
    losses = nb_plays - wins
    return 100. * (0.5 + 0.5 *  math.erf((wins - losses)/ math.sqrt((2.*(wins + losses)))))
